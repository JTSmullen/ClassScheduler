...
export class AuthService {
  private readonly AUTH_URL = 'http://lfrgiy6ixwc3psnimphcam4npa0rxxbq.lambda-url.us-east-2.on.aws/api/v1/auth';
  private readonly USER_URL = 'http://lfrgiy6ixwc3psnimphcam4npa0rxxbq.lambda-url.us-east-2.on.aws/api/v1/user';
